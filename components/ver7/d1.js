...
export default function Ver7_D1() {
    ...
    <div className={`container ${phase !== 'idle' ? 'container--bright' : ''}`}>
      ...
      <style jsx>{`
        ...
        .glass-layer {
          ...
          padding: clamp(24px, 6vh, 56px) clamp(20px, 8vw, 68px);
          box-sizing: border-box;
        ...
        .message-input button:hover {
          ...
          box-shadow:
            inset 0 1px 0 rgba(255,255,255,0.78),
            0 12px 18px rgba(48, 24, 78, 0.18);
        }
        .message-input button:focus { outline: none; }
        .message-top {
          position: absolute;
