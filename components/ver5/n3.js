...
const BlobMono = styled.div`
  ...
  --p3x: 32%; --p3y: 28%;
  --p4x: 58%; --p4y: 28%;
  /* Match n1 pastel palette: #C6FFB0, #B4FDE5, #CCF2FF, #EEEFFF */
  background:
    radial-gradient(farthest-side at var(--p1x) var(--p1y), rgba(198,255,176,0.90) 0%, rgba(198,255,176,0.48) var(--s1), rgba(198,255,176,0.00) var(--s1o)),
    radial-gradient(farthest-side at var(--p2x) var(--p2y), rgba(180,253,229,0.92) 0%, rgba(180,253,229,0.55) var(--s2), rgba(180,253,229,0.00) var(--s2o)),
    radial-gradient(farthest-side at var(--p3x) var(--p3y), rgba(204,242,255,0.70) 0%, rgba(204,242,255,0.00) var(--s3)),
    radial-gradient(farthest-side at var(--p4x) var(--p4y), rgba(238,239,255,0.65) 0%, rgba(238,239,255,0.00) var(--s4)),
  ...
  /* Faster movement */
  animation:
    ${l1} 3.0s ease-in-out infinite alternate,
    ${l2} 3.2s ease-in-out infinite alternate,
    ${l3} 3.4s ease-in-out infinite alternate,
    ${l4} 3.6s ease-in-out infinite alternate,
    ${b1} 3.2s ease-in-out infinite alternate,
    ${b2} 3.4s ease-in-out infinite alternate,
    ${b3} 3.6s ease-in-out infinite alternate,
    ${b4} 3.8s ease-in-out infinite alternate;
