    ...
    <div className={`container container--bright ${bottomVisible ? 'container--bottom-visible' : ''}`}>
      ...
      <style jsx>{`
        ...
        .top-heading {
          ...
          width: calc(100% - var(--glass-side) * 2);
          color: #2e3d46;
          font-weight: 700;
          font-size: 18px;
          text-align: center;
        ...
        .glass-content {
          ...
          padding: clamp(34px, 7.2vw, 42px) var(--glass-inner) clamp(34px, 7.2vw, 42px);
        ...
        .suggestions--visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
        .chip {
          justify-self: start;
          max-width: 100%;
          ...
          background: linear-gradient(180deg, rgba(255,255,255,0.58) 0%, rgba(255,255,255,0.24) 100%);
          box-shadow:
            inset 0 1px 0 rgba(255,255,255,0.85),
            0 10px 24px rgba(40, 80, 96, 0.12);
          backdrop-filter: blur(16px) saturate(1.2);
          color: rgba(56,65,85,0.62);
          font-weight: 500;
          font-size: 14px;
          pointer-events: auto;
          white-space: nowrap;
