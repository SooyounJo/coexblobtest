...
const Ver3 = () => {
  ...
  const [feather, setFeather] = useState(15); // % width for soft transition

  const [innerBlur, setInnerBlur] = useState(20); // small blur for core edge
  ...
  return (
    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        /* Animatable custom properties to pulse mask ranges */
        ...
        /* extra outer boost ring - stronger blur near outer edge only */
        .ring-boost {
        ...
        /* soft purple background glow behind the blob */
        .bg-glow {
        ...
        /* sharp core - 0 ~ start, with feather fade */
        ...
        /* blurred ring - start ~ end, feathered on both sides, with purple tint */

        .blob::after {

          /* tint the ring with soft purple and blur */
          background:
            var(--bg),
            radial-gradient(circle at var(--center-x) var(--center-y),
        ...
        /* directional highlight with composite */
