    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        .cta {
          ...
          box-shadow:
            0 20px 36px rgba(32, 56, 78, 0.24),
        ...
        .cta::after {
          ...
          border-radius: 999px;
          background:
            radial-gradient(circle at 24% 18%, rgba(255,255,255,0.42), transparent 64%),
            radial-gradient(circle at 78% 82%, rgba(136,212,255,0.26), transparent 70%),
        ...
        .cta:hover {
          box-shadow:
            0 24px 44px rgba(32, 56, 78, 0.28),
