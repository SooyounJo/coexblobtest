    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        .cta {
          ...
          width: clamp(280px, 94vw, 420px);
          height: clamp(78px, 15vw, 108px);
          border-radius: clamp(42px, 8.4vw, 56px) clamp(42px, 8.4vw, 56px) 0 0;
          border: 2px solid rgba(158, 230, 255, 0.68);
          border-bottom: none;
          background:
            linear-gradient(162deg, rgba(246, 255, 255, 0.85) 0%, rgba(210, 248, 255, 0.48) 38%, rgba(134, 224, 255, 0.26) 100%),
            rgba(234, 248, 255, 0.32);
          box-shadow:
            0 -2px 0 rgba(255,255,255,0.82) inset,
            0 30px 58px rgba(36, 96, 118, 0.34);
          backdrop-filter: blur(30px) saturate(1.82);
          color: #0a2f30;
        ...
        .cta::after {
          ...
          border-radius: clamp(42px, 8.4vw, 56px) clamp(42px, 8.4vw, 56px) 0 0;
          background:
            radial-gradient(circle at 24% 18%, rgba(255,255,255,0.52), transparent 62%),
            radial-gradient(circle at 78% 80%, rgba(132, 224, 255, 0.34), transparent 70%),
            rgba(234,248,255,0.12);
          opacity: 0.36;
          filter: blur(48px) saturate(1.32);
          pointer-events: none;
        }
        .cta:hover {
          ...
          box-shadow:
            ...
            0 36px 66px rgba(36, 96, 118, 0.4);
        }
        .stage {
          height: 100%;
          display: grid;
